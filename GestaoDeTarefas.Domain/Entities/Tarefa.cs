...
public class Tarefa
{
    ...
    public Tarefa(string titulo, string? descricao, DateTime? dataVencimento, StatusTarefa status)
    {
        Atualizar(titulo, descricao, dataVencimento, status);
    }

    public void Atualizar(string titulo, string? descricao, DateTime? dataVencimento, StatusTarefa status)
    {
